<template>
  <div v-click-outside="onClickedOutside" ref="container"  class="container">
    <div class="bar">
    <div class="location bar-div" :class="{'clicked':showLocationsModal}" @click="showLocationsModal = true, showGuestsModal = false , showDatesModal = false , checkInClicked = false , checkOutClicked = false">
      <p>Location</p>
    ...
    <div class="check-in bar-div" :class="{'clicked':checkInClicked}" @click="showLocationsModal = false, showGuestsModal = false , showDatesModal = true , checkInClicked = true , checkOutClicked = false">
      <p>Check in</p>
    ...
    <div class="check-out bar-div" :class="{'clicked':checkOutClicked}" @click="showLocationsModal = false , showGuestsModal = false , showDatesModal = true , checkInClicked = false , checkOutClicked = true">
      <p>Check out</p>
      <input type="text" v-model="getDates.end" placeholder="Add dates" @keyup.enter="setSearch()"/>
    </div>

    <div class="guests bar-div" :class="{'clicked':showGuestsModal}"  @click="showDatesModal = false , showLocationsModal = false , showGuestsModal = true , checkInClicked = false , checkOutClicked = false" >
    <div>
      <p>Guests</p>
    ...
    <GuestsModal 
    v-if ="showGuestsModal" @setChildrenCount="setChildrenCount($event)" @setAdultCount="setAdultCount1($event)"
                @setInfantsCount="setInfantsCount($event)" @setPetsCount="setPetsCount($event)" style="top:153px ; right:5px; font-size:initial ; border-radius: 32px ; box-shadow: 0 0 0 1px rgba(0, 0, 0, 0.0392156863), 0 8px 16px rgba(0, 0, 0, 0.1490196078);"/>
