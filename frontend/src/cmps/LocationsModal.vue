<template>
<container class="locations-container">
<article v-for="location in locations" :key = "location.country" class="location-container" @click="submitPick(location.city , location.country) , $emit('close')">
...
methods:{
    submitPick(city, country){

    this.$emit('passData' , {country:country})
