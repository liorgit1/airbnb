<template>
  <section class="additional-amenities">
    <h1 style="font-size: 22px;" class="title fs12">What this place offers</h1>
    <div class="amenities flex">
      <div class="amenity flex">
        <svg class="amenity-img" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
      ...
      <div class="amenity flex">
        <svg class="amenity-img" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
          role="presentation" focusable="false" style="
              ...
              ">
          <path
            d="M30 19v8h-2v-8zm-4 0v8H3a2 2 0 0 1-1.995-1.85L1 25v-4a2 2 0 0 1 1.85-1.995L3 19zm-2 2H3v4h21zM21 3a4 4 0 0 1 3.356 6.178l-.1.145.137.041a8.004 8.004 0 0 1 5.603 7.387L30 17h-2a6 6 0 0 0-5.775-5.996L22 11h-1V9a2 2 0 0 0 .15-3.995L21 5zm-4 0v2a4 4 0 0 0-.2 7.995L17 13h5a4 4 0 0 1 3.995 3.8L26 17h-2a2 2 0 0 0-1.85-1.995L22 15h-5a6 6 0 0 1-.225-11.996z">
          </path>
        </svg>
