...
<section class="main-layout" >
    ...
    <div class="mini-card next-stay flex row space-between grid-item-1" v-for="stay in user.stays" :key="stay">
        <div class="next-stay-first flex row wrap">
            ...
            <h4 style="line-height: 15px;"><p>{{stays.summery}}</p></h4>
            <h4 style="letter-spacing: -1px;"><p>From {{ orders.startDate }} to {{ orders.endDate }}</p></h4>
            <h4 style="letter-spacing: -1px;"><p>Check-In for {{ orders.stayTime }} guests</p></h4>
