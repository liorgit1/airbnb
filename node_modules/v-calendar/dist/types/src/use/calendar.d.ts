...
export declare function createCalendar(props: CalendarProps, { emit, slots }: any): {
    ...
    focusedDay: import("vue").Ref<{
        ...
        locale: {
            ...
            toDate: (d: DateSource | Partial<import("../utils/date/helpers").SimpleDateParts>, opts?: Partial<import("../utils/date/helpers").DateOptions>) => Date;
            toDateOrNull: (d: DateSource | Partial<import("../utils/date/helpers").SimpleDateParts>, opts?: Partial<import("../utils/date/helpers").DateOptions>) => Date | null;
