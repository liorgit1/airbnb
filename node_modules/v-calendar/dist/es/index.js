...
import { openBlock, createElementBlock, createElementVNode, defineComponent, computed, createBlock, resolveDynamicComponent, unref, ref, watch, onUnmounted, reactive, provide, inject, onMounted, watchEffect, normalizeClass, normalizeStyle, renderSlot, withKeys, createVNode, createCommentVNode, withDirectives, createTextVNode, toDisplayString, normalizeProps, mergeProps, resolveComponent, resolveDirective, Fragment, renderList, withCtx, toHandlers, toRefs, nextTick, Transition, withModifiers, guardReactiveProps, toRef, isRef, h } from "vue";
...
const _hoisted_2$a = /* @__PURE__ */ createElementVNode("polyline", { points: "9 18 15 12 9 6" }, null, -1);
const _hoisted_3$8 = [
  _hoisted_2$a
];
...
const _hoisted_2$9 = /* @__PURE__ */ createElementVNode("polyline", { points: "15 18 9 12 15 6" }, null, -1);
const _hoisted_3$7 = [
  _hoisted_2$9
];
...
const _hoisted_2$8 = /* @__PURE__ */ createElementVNode("polyline", { points: "6 9 12 15 18 9" }, null, -1);
const _hoisted_3$6 = [
  _hoisted_2$8
];
...
const _hoisted_2$7 = /* @__PURE__ */ createElementVNode("path", { d: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" }, null, -1);
const _hoisted_3$5 = [
  _hoisted_2$7
];
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        renderSlot(_ctx.$slots, "header-left-button", { move: unref(movePrev) }, () => [
          unref(show).prev ? (openBlock(), createElementBlock("button", {
            key: 0,
            class: normalizeClass(["vc-arrow vc-prev vc-focus", { "vc-disabled": !unref(canMovePrev) }]),
            role: "button",
            type: "button",
        ...
        unref(show).title ? withDirectives((openBlock(), createElementBlock("div", _hoisted_1$8, [
        ...
        renderSlot(_ctx.$slots, "header-right-button", { move: unref(moveNext) }, () => [
          unref(show).next ? (openBlock(), createElementBlock("button", {
            key: 0,
            class: normalizeClass(["vc-arrow vc-next vc-focus", { "vc-disabled": !unref(canMoveNext) }]),
            role: "button",
            type: "button",
...
const _sfc_main$a = defineComponent({
  ...
  components: { CalendarSlot: _sfc_main$b },
  props: {
...
const _sfc_main$9 = {
  name: "CalendarPane",
  inheritAttrs: false,
  components: { CalendarHeader: _sfc_main$c, CalendarDay },
  props: {
    page: { type: Object, required: true }
  },
  setup() {
...
const _hoisted_5$1 = ["data-id", "aria-label", "tabindex", "onClick", "onKeydown"];
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", _hoisted_1$5, [
          createElementVNode("span", {
            role: "button",
            class: normalizeClass(["vc-nav-arrow is-left vc-focus", { "vc-disabled": !unref(prevItemsEnabled) }]),
            tabindex: unref(prevItemsEnabled) ? 0 : void 0,
            onClick: _cache[0] || (_cache[0] = //@ts-ignore
            (...args) => unref(movePrev) && unref(movePrev)(...args)),
          ...
          createElementVNode("span", {
            role: "button",
            class: normalizeClass(["vc-nav-arrow is-right", { "vc-disabled": !unref(nextItemsEnabled) }]),
            tabindex: unref(nextItemsEnabled) ? 0 : void 0,
        ...
        createElementVNode("div", _hoisted_4$1, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(activeItems), (item) => {
            return openBlock(), createElementBlock("span", {
              ...
              class: normalizeClass(unref(getItemClasses)(item)),
